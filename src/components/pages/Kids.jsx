            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-md-4 d-flex flex-column justify-content-center">
                        <p className="header--welcome p-0 m-0 w-100">
                            <span className="shade--blue">Kid</span>'s Corner
                        </p>
                    </div>
                ...
                <div className="row py-1">
                    <KidSection heading="Spaceship Maze" content="Help the spaceship through the maze to get back to earth. Move through levels with increasing difficulty; each puzzle starts the ship in a different location. Develop kids' skills in strategizing, spatial awareness, hand-eye coordination, problem solving and more! Free to play, priceless for learning." backgroundColor="#0083f9" image={maze} />
                </div>
                <div className="row py-1">
